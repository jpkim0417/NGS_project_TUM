...
#uploading FASTA file and GFF3 file to the cluster(파스타 파일이랑 gff3 다운 먼저 필요)
#Step 1 다운로드 : NCBI Download FASTA and GFF3 file from NCBI (https://www.ncbi.nlm.nih.gov/nuccore/NC_043858.1, https://www.ncbi.nlm.nih.gov/nuccore/NC_040009.1, https://www.ncbi.nlm.nih.gov/nuccore/NC_046388.1, https://www.ncbi.nlm.nih.gov/nuccore/NC_039556.1, https://www.ncbi.nlm.nih.gov/nuccore/OP750007.1 (GFF3 file for sample5), https://www.ncbi.nlm.nih.gov/nuccore/NC_037251.1 (FASTA file for sample5))
#Step 2 After downloading them, the file name was changed "{genome_name}_Chl.fasta/gff3". ex)Quercus_mongolica_Chl.fasta
#Step 3 클러스터 업로드 srp -r Transfer the "FASTA/GFF3" files into each species' directory. 
#Step 4 각자 디렉토리에 옮김
...
vcfallelicprimitives -kg Quercus_mongolica.raw_variants.vcf > Quercus_mongolica.raw_variants_split.vcf
...
vcfallelicprimitives -kg Swietenia_mahagoni.raw_variants.vcf > Swietenia_mahagoni.raw_variants_split.vcf
...
vcfallelicprimitives -kg Quercus_robur.raw_variants.vcf > Quercus_robur.raw_variants_split.vcf
...
vcfallelicprimitives -kg Diospyros_rhombifolia.raw_variants.vcf > Diospyros_rhombifolia.raw_variants_split.vcf
...
vcfallelicprimitives -kg Cedrela_odorata.raw_variants.vcf > Cedrela_odorata.raw_variants_split.vcf
...
###
cat Cedrela_odorata.DP_Qualifilt.vcf | sed "s/^NC_037251.1/OP750007.1/" > Cedrela_odorata.DP_Qualifilt_2.vcf
###
...
sed -i 's/>NC_037251.1/>OP750007.1/' sequences.fa
...
snpEff ann Cedrela_odorata ~/NGS_project/illegal_logging_trees/VariantCalling/Cedrela_odorata.DP_Qualifilt_2.vcf > Cedrela_odorata_flt_ann.vcf
