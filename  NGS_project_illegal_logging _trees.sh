...
vcffilter -f 'QUAL / AO < 10' Quercus_mongolica.raw_variant_split.vcf > Quercus_mongolica.fail.vcf
...
vcffilter -f 'QUAL / AO < 10' Swietenia_mahagoni.raw_variant_split.vcf > Swietenia_mahagoni.fail.vcf
...
vcffilter -f 'QUAL / AO < 10' Quercus_robur.raw_variant_split.vcf > Quercus_robur.fail.vcf
...
vcffilter -f 'QUAL / AO < 10' Diospyros_rhombifolia.raw_variant_split.vcf > Diospyros_rhombifolia.fail.vcf
...
vcffilter -f 'QUAL / AO < 10' Cedrela_odorata.raw_variant_split.vcf > Cedrela_odorata.fail.vcf
